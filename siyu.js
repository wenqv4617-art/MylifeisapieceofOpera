      ...
      return `
        <button class="siyu-chat-item" data-act="open-chat" data-id="${c.id}">
          ...
          <div class="siyu-chat-main">
            ...
            <div class="siyu-chat-preview">${esc(c.preview || "点击继续对话")}</div>
          </div>
        </button>
      `;
    }).join("");
    ...
    const html = state.chars.map(p => `
      <button class="siyu-chat-item" data-act="create-single" data-id="${p.id}">
        ...
        <div class="siyu-chat-main">
          ...
          <div class="siyu-chat-preview">${esc(p.details || "点击创建单聊")}</div>
        </div>
      </button>
    `).join("");
      ...
      <div class="siyu-sticker-page">
        ...
        <section class="siyu-sticker-panel">
          <div class="siyu-sticker-tools">
            <button class="siyu-mini-btn primary" data-act="upload-sticker">上传</button>
            <button class="siyu-mini-btn" data-act="batch-upload-sticker">批量上传</button>
            <button class="siyu-mini-btn" data-act="url-sticker">URL</button>
            <button class="siyu-mini-btn" data-act="paste-sticker">批量粘贴</button>
            <button class="siyu-mini-btn danger" data-act="delete-sticker-group">删组</button>
          </div>
