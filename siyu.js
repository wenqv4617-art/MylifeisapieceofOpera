(function () {
  ...
  upload: `<svg viewBox="0 0 24 24"><path d="M12 4V14"/><path d="M8 10L12 6L16 10"/><path d="M4 16V18C4 19.1 4.9 20 6 20H18C19.1 20 20 19.1 20 18V16"/></svg>`,
  batch: `<svg viewBox="0 0 24 24"><path d="M4 16V18C4 19.1 4.9 20 6 20H18C19.1 20 20 19.1 20 18V16"/><path d="M12 4V14"/><path d="M8 10L12 14L16 10"/><path d="M4 16V18C4 19.1 4.9 20 6 20H18C19.1 20 20 19.1 20 18V16"/></svg>`,
  url: `<svg viewBox="0 0 24 24"><path d="M10 13L14 9"/><path d="M9 16L15 10"/><path d="M12 4C8.7 4 6 6.7 6 10C6 10.9 6.2 11.8 6.5 12.6L5.3 13.8C4.2 14.9 4.2 16.8 5.3 17.9C6.4 19 8.3 19 9.4 17.9L10.6 16.7C11.4 17 12.3 17.2 13.2 17.2C16.5 17.2 19.2 14.5 19.2 11.2C19.2 7.9 16.5 5.2 13.2 5.2L12 4Z"/></svg>`,
  paste: `<svg viewBox="0 0 24 24"><path d="M4 6.5H10"/><path d="M4 11.5H8"/><path d="M4 16.5H7"/><path d="M14 4.5H19C20.1 4.5 21 5.4 21 6.5V18.5C21 19.6 20.1 20.5 19 20.5H5C3.9 20.5 3 19.6 3 18.5V7.5L8 2.5H14"/><path d="M14 2.5V6.5H18"/></svg>`,
  delete: `<svg viewBox="0 0 24 24"><path d="M6 6L18 18"/><path d="M18 6L6 18"/></svg>`
  };
  ...
  setHeader("私语", "聊天", {
    right: [{ svg: icon.plus, act: "new-single" }]
  });
  ...
  if (!chats.length) {
    main.innerHTML = `
      <div class="siyu-scroll">
        <div class="siyu-empty">还没有聊天。点击右上角新建单聊。</div>
      </div>
    `;
    return;
  }
  ...
  async function openChat(id) {
    ...
    const messages = await db.messages.where("chatId").equals(state.currentChatId).sortBy("createdAt");
    ...
    <div class="siyu-sticker-page">
      ...
      <section class="siyu-sticker-panel">
        <div class="siyu-sticker-tools">
          <button class="siyu-mini-btn primary" data-act="upload-sticker" title="上传">${icon.plus}</button>
          <button class="siyu-mini-btn" data-act="batch-upload-sticker" title="批量上传">
            <svg viewBox="0 0 24 24"><path d="M4 16V18C4 19.1 4.9 20 6 20H18C19.1 20 20 19.1 20 18V16"/><path d="M12 4V14"/><path d="M8 10L12 14L16 10"/><path d="M4 16V18C4 19.1 4.9 20 6 20H18C19.1 20 20 19.1 20 18V16"/></svg>
          </button>
          <button class="siyu-mini-btn" data-act="url-sticker" title="URL导入">
            <svg viewBox="0 0 24 24"><path d="M10 13L14 9"/><path d="M9 16L15 10"/><path d="M12 4C8.7 4 6 6.7 6 10C6 10.9 6.2 11.8 6.5 12.6L5.3 13.8C4.2 14.9 4.2 16.8 5.3 17.9C6.4 19 8.3 19 9.4 17.9L10.6 16.7C11.4 17 12.3 17.2 13.2 17.2C16.5 17.2 19.2 14.5 19.2 11.2C19.2 7.9 16.5 5.2 13.2 5.2L12 4Z"/></svg>
          </button>
          <button class="siyu-mini-btn" data-act="paste-sticker" title="批量粘贴">
            <svg viewBox="0 0 24 24"><path d="M4 6.5H10"/><path d="M4 11.5H8"/><path d="M4 16.5H7"/><path d="M14 4.5H19C20.1 4.5 21 5.4 21 6.5V18.5C21 19.6 20.1 20.5 19 20.5H5C3.9 20.5 3 19.6 3 18.5V7.5L8 2.5H14"/><path d="M14 2.5V6.5H18"/></svg>
          </button>
          <button class="siyu-mini-btn danger" data-act="delete-sticker-group" title="删除分组">
            <svg viewBox="0 0 24 24"><path d="M6 6L18 18"/><path d="M18 6L6 18"/></svg>
          </button>
        </div>
  ...
  modal.innerHTML = `
    <div class="siyu-sticker-modal-card">
      ...
      <div class="siyu-sticker-modal-actions">
        ...
        <button class="siyu-mini-btn primary" data-act="save-sticker-text">保存</button>
        <button class="siyu-mini-btn danger" data-act="delete-sticker">删除</button>
      </div>
    </div>
  `;
...
文字:URL;"></textarea>
        <div class="siyu-modal-actions">
          ...
          <button class="siyu-mini-btn primary" data-act="confirm-paste-sticker">导入</button>
        </div>
      </div>
    `;
  }
